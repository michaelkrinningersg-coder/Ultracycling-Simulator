...
| Rennen (M3) | Vektorisiert über das ganze Feld, Einzelstart, Splitzeiten mit Sub-Tick-Interpolation an höchstens zwanzig Marken (alle 5 % der Strecke) plus jedem kategorisierten Gipfel, Ereignis-Strom, quantisierte Telemetrie |
...
| Übertragungsraum | Was aus einer Anzeige eine Übertragung macht: eine abschaltbare **Regie**, deren Fokus dem folgt, bei dem gerade etwas passiert (Aufgabe, Sturz, Defekt, Hungerast, Bestzeit, Ziel), **Höhenachse und beschriftete Anstiege** im Ausschnitt samt „noch 4,2 km bis oben", **elf wählbare Board-Spalten** und jede Spalte sortierbar, der **Aufgabedruck** als eigener Telemetriekanal, ein **Richtungspfeil** je Zeile, **zwei anheftbare Fahrer** mit dem Abstand zwischen ihnen, ein **Ticker mit Themenchips**, dessen Meldungen anklickbar sind (Uhr springt hin, Fokus wechselt), und eine nach Team oder Nation **gefaltete Startliste** |
...
| Ampeln | Öffentliche Straßen haben Ampeln: 90 s rot, 90 s grün, höchstens zwei je hundert Kilometer, mindestens fünf Kilometer Abstand, keine im Anstieg und keine über 1200 m. Der **erste Halt im Modell, den niemand plant und niemand verschuldet** — die Wartezeit steht in der Standzeit, aber nicht im Zwischenfallkonto, das den Aufgabedruck treibt. Die Phase läuft in Fahrer-Eigenzeit, damit der Startversatz nicht in die Simulation eingeht; die Ampeln gehören der Strecke und werden aus ihrem Namen abgeleitet |
...
| Aufgabe (M6.2) | Vier Wege zum DNF: schwerer Sturz, schwerer Defekt ohne Ersatz, Zeitlimit (2,0 × Siegerzeit) und ein kumulativer Aufgabe-Score aus verlorener Zeit × Ermüdung × Magenzustand, gedämpft durch mentale Widerstandsfähigkeit. **Notschlaf zählt dabei nicht als verlorene Zeit** — auf einer Strecke mit fünf Nächten ist Schlaf der Plan, nicht sein Scheitern, und über den Schlafdruck steckt er ohnehin schon im Ermüdungsterm |
...
| Statistik | Drei Seiten mit Nebenwertungen: **je Rennen** Teamwertung (Summe der drei besten Zielzeiten), Bergwertung (Punkte je kategorisiertem Anstieg, nach der reinen Anstiegszeit vom Fuß bis zum Gipfel, mit VAM) und Energiebilanz (aufgenommene gegen verbrannte Kohlenhydrate); **je Saison** Team- und Nationenwertung; **über alles** die Streckenrekorde mit Fahrer, Team und Rennen |
| Auswertung | Warum-Panel: die Form in ihre Faktoren zerlegt, der teuerste zuerst — die Simulation zeichnet Abschnittsform, Ermüdung, Zustände, Hungerast, Schlaf, Wetter und Flüssigkeit als eigene Kanäle auf. Splitzeiten-Matrix Fahrer × Marke mit Rangfarbe **und dieselben Zahlen als Rangverlauf**, die Standzeit aufgeschlüsselt nach Notschlaf und Zwischenfall, ein Rennbericht in einem Satz je Fahrer — **für das Podium in mehreren** — und die Gesamtwertung als Verlauf über die Termine |
...
| Werkzeuge | CLI für Pool, Rennen, Ergebnis, Fahrerdetail, Saison und Kalibrierung, Balancing-Batch mit Abgleich gegen Dauerbänder und DNF-Korridor, 632 Tests inklusive zweier Golden-Master |
